		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CSS Models Bindings",
									"targetURL": "#iopbcssmodelsbindings-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbcssmodelsbindings-display": {
								"semanticObject": "iopbcssmodelsbindings",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.cssmodelsbindings",
									"url": sap.ui.require.toUrl("io/pb/cssmodelsbindings")
								}
							}
						}
					}
