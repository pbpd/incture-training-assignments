		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CSS Models Binding",
									"targetURL": "#iopbcssmodelsbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbcssmodelsbinding-display": {
								"semanticObject": "iopbcssmodelsbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.cssmodelsbinding",
									"url": sap.ui.require.toUrl("io/pb/cssmodelsbinding")
								}
							}
						}
					}
