		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#iopbq3responsivescreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbq3responsivescreen-display": {
								"semanticObject": "iopbq3responsivescreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.q3responsivescreen",
									"url": sap.ui.require.toUrl("io/pb/q3responsivescreen")
								}
							}
						}
					}
