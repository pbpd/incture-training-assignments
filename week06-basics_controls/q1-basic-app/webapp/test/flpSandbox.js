		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Basic UI5 Application",
									"targetURL": "#iopbq1basicapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbq1basicapp-display": {
								"semanticObject": "iopbq1basicapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.q1basicapp",
									"url": sap.ui.require.toUrl("io/pb/q1basicapp")
								}
							}
						}
					}
