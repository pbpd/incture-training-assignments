		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Search List",
									"targetURL": "#iopbq2searchlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbq2searchlist-display": {
								"semanticObject": "iopbq2searchlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.q2searchlist",
									"url": sap.ui.require.toUrl("io/pb/q2searchlist")
								}
							}
						}
					}
