		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sort Group",
									"targetURL": "#iopbq3sortgroup-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbq3sortgroup-display": {
								"semanticObject": "iopbq3sortgroup",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.q3sortgroup",
									"url": sap.ui.require.toUrl("io/pb/q3sortgroup")
								}
							}
						}
					}
