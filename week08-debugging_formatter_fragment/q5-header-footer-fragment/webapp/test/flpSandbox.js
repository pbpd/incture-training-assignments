		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#q5headerfooterfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"q5headerfooterfragment-display": {
								"semanticObject": "q5headerfooterfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=q5headerfooterfragment",
									"url": sap.ui.require.toUrl("q5headerfooterfragment")
								}
							}
						}
					}
