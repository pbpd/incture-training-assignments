		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#q7q8formatter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"q7q8formatter-display": {
								"semanticObject": "q7q8formatter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=q7q8formatter",
									"url": sap.ui.require.toUrl("q7q8formatter")
								}
							}
						}
					}
