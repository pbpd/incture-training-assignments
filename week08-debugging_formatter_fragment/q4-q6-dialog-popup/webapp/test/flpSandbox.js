		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iopbq6button-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbq6button-display": {
								"semanticObject": "iopbq6button",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb",
									"url": sap.ui.require.toUrl("io/pb/q6button")
								}
							}
						}
					}
